#!/usr/bin/env python3
"""
Command-line interface for generating waveform datasets with dingo-waveform.
...
from .dataset.dataset_settings import DatasetSettings
from .dataset.generate import generate_waveform_dataset
...
def generate_dataset_main(
    ...
    ------
    FileNotFoundError
        If settings file or output directory does not exist.
    ValueError
...
def main() -> None:
    """Entry point for dingo_generate_dataset command-line tool."""
    args = parse_args()
