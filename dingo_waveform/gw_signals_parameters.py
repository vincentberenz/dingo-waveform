...
class GwSignalParameters(TableStr):
    ...
    lmax_nyquist, postadiabatic, and postadiabatic_type are specifically used in
    advanced waveform calculations, particularly with the SEOBNRv5 model.
    """
    ...
    def from_binary_black_hole_parameters(
        ...
        lmax_nyquist
            ...
            angular resolution included in the waveform calculation (default: None)
        postadiabatic
