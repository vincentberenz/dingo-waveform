"""
Waveform-related transform classes.
"""
...
class DecimateAll:
    ...
    def __call__(self, input_sample: Dict[str, Any]) -> Dict[str, Any]:
        """
        Apply decimation transform.

        Parameters
        ----------
        input_sample : Dict[str, Any]
            Input sample with nested dicts/arrays to decimate
...
class DecimateWaveformsAndASDS:
    ...
    def __call__(self, input_sample: Dict[str, Any]) -> Dict[str, Any]:
        """
        Apply waveform and ASD decimation.
        ...
        -------
        Dict[str, Any]
            Sample with decimated waveforms and asds
        """
        sample = input_sample.copy()
...
class CropMaskStrainRandom:
    """Apply random cropping of strain, by masking waveform and ASD outside the crop."""

    def __init__(
        self,
        domain: Union[UniformFrequencyDomain, MultibandedFrequencyDomain],
        ...
        deterministic_fmin_fmax: Optional[
            Union[list[Union[float, None]], list[list[Union[float, None]]]]
        ] = None,
    ) -> None:
        """
        Parameters
...
class MaskDataForFrequencyRangeUpdate:
    """
...
def create_mask_based_on_frequency_update(
    ...
    ----------
    sample_frequencies: np.array
        Frequency values for which we want to create a mask.
    detectors: list[str]
    ...
    frequency_masks: dict
        Dictionary providing a boolean mask for the sample frequencies of each detector.
    """
    frequency_masks = {
