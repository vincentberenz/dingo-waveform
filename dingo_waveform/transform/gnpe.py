"""
Group-equivariant Neural Posterior Estimation (GNPE) transform classes.
"""
...
class GNPEBase(ABC):
    ...
    def __init__(self, kernel_dict: Dict[str, Any], operators: Dict[str, str]) -> None:
        """
        Parameters
        ----------
    ...
    def perturb(self, g: Any, k: str) -> Any:
        """
    ...
    def multiply(self, a: Any, b: Any, k: str) -> Any:
        """
        ...
        b : Any
            Second operand
        k : str
            Parameter name to determine operator

        Returns
        -------
        Any
            Result of group multiplication
        """
        op = self.operators[k]
        if op == "+":
            return a + b
    ...
    def inverse(self, a: Any, k: str) -> Any:
        """
...
class GNPECoalescenceTimes(GNPEBase):
    ...
    def __call__(self, input_sample: Dict[str, Any]) -> Dict[str, Any]:
        ...
        -------
        Dict[str, Any]
            Sample with GNPE proxies and modified detector times
        """
